          ...
          <Card.Body>
            ...
            <Flex direction='row' gap={8}>
              <Flex direction='column'>
                ...
                <Input variant='flushed' placeholder='入力してください' w='170px' css={{ "--focus-color": "teal" }} mb={3}onChange={e => handleChange("name", e.target.value)}></Input>
              </Flex>
              <Flex direction='column'>
                <Text fontSize='sm'>ふりがな</Text>
                <Input variant='flushed' placeholder='入力してください' w='170px' css={{ "--focus-color": "teal" }}onChange={e => handleChange("furigana", e.target.value)}></Input>
              </Flex>
            </Flex>
